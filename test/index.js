...
// TFN: isNumberBetween
console.log('Testing: isNumberBetween..');
...
[
  ...
  expect(utils.isNumberBetween(test[0], test[1], test[2])).to.equal(test[3]);
});
...
// TFN: isDateBetween
console.log('Testing: isDateBetween..');

[
  [new Date(2000,  0,  1,  0,  0,  0,   0), new Date(2000, 0, 1, 0, 0, 0, 0), new Date(2000, 0, 1, 0, 0, 0, 0), true],
  [new Date(2000,  0,  1,  0,  0,  0,   0), new Date(2000, 0, 1, 0, 0, 0, 0), new Date(2000, 0, 2, 0, 0, 0, 0), true],
  [new Date(2000,  0,  2,  0,  0,  0,   0), new Date(2000, 0, 1, 0, 0, 0, 0), new Date(2000, 0, 2, 0, 0, 0, 0), true],
  [new Date(2000,  0,  1, 23, 59, 59, 999), new Date(2000, 0, 1, 0, 0, 0, 0), new Date(2000, 0, 2, 0, 0, 0, 0), true],

  [new Date(1999, 11, 31, 23, 59, 59, 999), new Date(2000, 0, 1, 0, 0, 0, 0), new Date(2000, 0, 2, 0, 0, 0, 0), false],
  [new Date(2000,  0,  2,  0,  0,  0,   1), new Date(2000, 0, 1, 0, 0, 0, 0), new Date(2000, 0, 2, 0, 0, 0, 0), false],
  [null,                                    new Date(2000, 0, 1, 0, 0, 0, 0), new Date(2000, 0, 2, 0, 0, 0, 0), false],
  [null,                                                                null, new Date(2000, 0, 2, 0, 0, 0, 0), false],
  [null,                                                                null,                             null, false]
].forEach(function (test) {
  expect(utils.isDateBetween(test[0], test[1], test[2])).to.equal(test[3]);
});
...
// TFN: dateSameYear
console.log('Testing: dateSameYear..');
[
  [[2000, 0, 1, 0, 0, 0, 0], [2000, 1, 1, 0, 0, 0, 0], true],
  [[2001, 1, 2, 1, 1, 1, 1], [2001, 2, 3, 1, 1, 1, 1], true],
  [[2002, 2, 3, 2, 2, 2, 2], [2002, 3, 3, 3, 2, 2, 2], true],
  [[2003, 3, 4, 3, 3, 3, 3], [2003, 4, 4, 4, 3, 3, 3], true],
  [[2004, 4, 5, 4, 4, 4, 4], [2004, 5, 5, 5, 4, 4, 4], true],
  [[2005, 5, 6, 5, 5, 5, 5], [2005, 6, 6, 5, 6, 5, 5], true],
  [[2006, 6, 7, 6, 6, 6, 6], [2006, 7, 7, 6, 6, 7, 6], true],

  [[2001, 0, 1, 0, 0, 0, 0], [2000, 0, 1, 0, 0, 0, 0], false],
  [[2002, 0, 1, 1, 1, 1, 1], [2001, 0, 1, 1, 1, 1, 1], false],
  [[2003, 0, 1, 2, 2, 2, 2], [2002, 0, 1, 2, 2, 2, 2], false],
  [[2004, 0, 1, 3, 3, 3, 3], [2003, 0, 1, 3, 3, 3, 3], false],
  [[2005, 0, 1, 4, 4, 4, 4], [2004, 0, 1, 4, 4, 4, 4], false],
  [[2006, 0, 1, 5, 5, 5, 5], [2005, 0, 1, 5, 5, 5, 5], false],
  [[2007, 0, 1, 6, 6, 6, 6], [2006, 0, 1, 6, 6, 6, 6], false]
].forEach(function (test) {
  var
  ad1 = test[0],
  ad2 = test[1],
  ...
  expect(utils.dateSameYear(d1, d2)).to.equal(!!test[2]);
});

// TFN: dateSameMonth
console.log('Testing: dateSameMonth..');
[
  [[2000, 0, 1, 0, 0, 0, 0], [2000, 0, 2, 0, 0, 0, 0], true],
  [[2001, 1, 2, 1, 1, 1, 1], [2001, 1, 3, 1, 1, 1, 1], true],
  [[2002, 2, 3, 2, 2, 2, 2], [2002, 2, 4, 2, 2, 2, 2], true],
  [[2003, 3, 4, 3, 3, 3, 3], [2003, 3, 5, 3, 4, 3, 3], true],
  [[2004, 4, 5, 4, 4, 4, 4], [2004, 4, 6, 4, 4, 5, 4], true],
  [[2005, 5, 6, 5, 5, 5, 5], [2005, 5, 7, 5, 5, 5, 6], true],
  [[2006, 6, 7, 6, 6, 6, 6], [2006, 6, 8, 6, 6, 6, 6], true],

  [[2000, 0, 1, 0, 0, 0, 0], [2000, 1, 1, 0, 0, 0, 0], false],
  [[2001, 1, 1, 1, 1, 1, 1], [2002, 1, 1, 1, 1, 1, 1], false],
  [[2002, 2, 1, 2, 2, 2, 2], [2002, 3, 1, 2, 2, 2, 2], false],
  [[2003, 3, 1, 3, 3, 3, 3], [2003, 4, 1, 3, 3, 3, 3], false],
  [[2004, 4, 1, 4, 4, 4, 4], [2004, 5, 1, 4, 4, 4, 4], false],
  [[2005, 5, 1, 5, 5, 5, 5], [2005, 6, 1, 5, 5, 5, 5], false],
  [[2006, 6, 1, 6, 6, 6, 6], [2006, 7, 1, 6, 6, 6, 6], false]
].forEach(function (test) {
  var
  ad1 = test[0],
  ad2 = test[1],
  ...
  expect(utils.dateSameMonth(d1, d2)).to.equal(!!test[2]);
});

// TFN: dateSameDay
console.log('Testing: dateSameDay..');
[
  [[2000, 0, 1, 0, 0, 0, 0], [2000, 0, 1, 1, 1, 1, 1], true],
  [[2001, 1, 2, 1, 1, 1, 1], [2001, 1, 2, 2, 2, 2, 2], true],
  [[2002, 2, 3, 2, 2, 2, 2], [2002, 2, 3, 3, 3, 3, 3], true],
  [[2003, 3, 4, 3, 3, 3, 3], [2003, 3, 4, 4, 4, 4, 4], true],
  [[2004, 4, 5, 4, 4, 4, 4], [2004, 4, 5, 5, 5, 5, 5], true],
  [[2005, 5, 6, 5, 5, 5, 5], [2005, 5, 6, 6, 6, 6, 6], true],
  [[2006, 6, 7, 6, 6, 6, 6], [2006, 6, 7, 7, 7, 7, 7], true],

  [[2000, 0, 1, 0, 0, 0, 0], [2000, 0, 2, 0, 0, 0, 0], false],
  [[2001, 1, 1, 1, 1, 1, 1], [2001, 2, 1, 1, 1, 1, 1], false],
  [[2002, 2, 1, 2, 2, 2, 2], [2003, 2, 1, 2, 2, 2, 2], false],
  [[2003, 3, 1, 3, 3, 3, 3], [2003, 3, 2, 3, 3, 3, 3], false],
  [[2004, 4, 1, 4, 4, 4, 4], [2004, 4, 3, 4, 4, 4, 4], false],
  [[2005, 5, 1, 5, 5, 5, 5], [2005, 5, 4, 5, 5, 5, 5], false],
  [[2006, 6, 1, 6, 6, 6, 6], [2006, 6, 5, 6, 6, 6, 6], false]
].forEach(function (test) {
  var
  ad1 = test[0],
  ad2 = test[1],
  ...
  expect(utils.dateSameDay(d1, d2)).to.equal(!!test[2]);
});

// TFN: dateSameHour
console.log('Testing: dateSameHour..');
[
  [[2000, 0, 1, 0, 0, 0, 0], [2000, 0, 1, 0, 1, 0, 0], true],
  [[2001, 1, 2, 1, 1, 1, 1], [2001, 1, 2, 1, 2, 1, 1], true],
  [[2002, 2, 3, 2, 2, 2, 2], [2002, 2, 3, 2, 3, 2, 2], true],
  [[2003, 3, 4, 3, 3, 3, 3], [2003, 3, 4, 3, 4, 3, 3], true],
  [[2004, 4, 5, 4, 4, 4, 4], [2004, 4, 5, 4, 5, 4, 4], true],
  [[2005, 5, 6, 5, 5, 5, 5], [2005, 5, 6, 5, 6, 5, 5], true],
  [[2006, 6, 7, 6, 6, 6, 6], [2006, 6, 7, 6, 7, 6, 6], true],

  [[2000, 0, 1, 0, 0, 0, 0], [2000, 0, 1, 1, 0, 0, 0], false],
  [[2001, 1, 1, 1, 1, 1, 1], [2001, 1, 2, 1, 1, 1, 1], false],
  [[2002, 2, 1, 2, 2, 2, 2], [2002, 3, 1, 2, 2, 2, 2], false],
  [[2003, 3, 1, 3, 3, 3, 3], [2004, 3, 1, 3, 3, 3, 3], false],
  [[2004, 4, 1, 4, 4, 4, 4], [2004, 4, 2, 4, 4, 4, 4], false],
  [[2005, 5, 1, 5, 5, 5, 5], [2005, 6, 1, 5, 5, 5, 5], false],
  [[2006, 6, 1, 6, 6, 6, 6], [2007, 6, 1, 6, 6, 6, 6], false]
].forEach(function (test) {
  var
  ad1 = test[0],
  ad2 = test[1],
  ...
  expect(utils.dateSameHour(d1, d2)).to.equal(!!test[2]);
});

// TFN: dateSameMinute
console.log('Testing: dateSameMinute..');
[
  [[2000, 0, 1, 0, 0, 0, 0], [2000, 0, 1, 0, 0, 1, 2], true],
  [[2001, 1, 2, 1, 1, 1, 1], [2001, 1, 2, 1, 1, 2, 3], true],
  [[2002, 2, 3, 2, 2, 2, 2], [2002, 2, 3, 2, 2, 3, 4], true],
  [[2003, 3, 4, 3, 3, 3, 3], [2003, 3, 4, 3, 3, 4, 5], true],
  [[2004, 4, 5, 4, 4, 4, 4], [2004, 4, 5, 4, 4, 5, 6], true],
  [[2005, 5, 6, 5, 5, 5, 5], [2005, 5, 6, 5, 5, 6, 7], true],
  [[2006, 6, 7, 6, 6, 6, 6], [2006, 6, 7, 6, 6, 7, 8], true],

  [[2000, 0, 1, 0, 0, 0, 0], [2000, 0, 1, 0, 1, 0, 0], false],
  [[2001, 1, 1, 1, 1, 1, 1], [2001, 1, 1, 2, 1, 1, 1], false],
  [[2002, 2, 1, 2, 2, 2, 2], [2002, 2, 2, 2, 2, 2, 2], false],
  [[2003, 3, 1, 3, 3, 3, 3], [2003, 4, 1, 3, 3, 3, 3], false],
  [[2004, 4, 1, 4, 4, 4, 4], [2005, 4, 1, 4, 4, 4, 4], false],
  [[2005, 5, 1, 5, 5, 5, 5], [2005, 6, 1, 5, 5, 5, 5], false],
  [[2006, 6, 1, 6, 6, 6, 6], [2006, 6, 2, 6, 6, 6, 6], false]
].forEach(function (test) {
  var
  ad1 = test[0],
  ad2 = test[1],
  ...
  expect(utils.dateSameMinute(d1, d2)).to.equal(!!test[2]);
});

// TFN: dateSameSecond
console.log('Testing: dateSameSecond..');
[
  [[2000, 0, 1, 0, 0, 0, 0], [2000, 0, 1, 0, 0, 0, 1], true],
  [[2001, 1, 2, 1, 1, 1, 1], [2001, 1, 2, 1, 1, 1, 2], true],
  [[2002, 2, 3, 2, 2, 2, 2], [2002, 2, 3, 2, 2, 2, 3], true],
  [[2003, 3, 4, 3, 3, 3, 3], [2003, 3, 4, 3, 3, 3, 4], true],
  [[2004, 4, 5, 4, 4, 4, 4], [2004, 4, 5, 4, 4, 4, 5], true],
  [[2005, 5, 6, 5, 5, 5, 5], [2005, 5, 6, 5, 5, 5, 6], true],
  [[2006, 6, 7, 6, 6, 6, 6], [2006, 6, 7, 6, 6, 6, 7], true],

  [[2000, 0, 1, 0, 0, 0, 0], [2000, 0, 1, 0, 0, 1, 0], false],
  [[2001, 1, 1, 1, 1, 1, 1], [2001, 1, 1, 1, 2, 1, 1], false],
  [[2002, 2, 1, 2, 2, 2, 2], [2002, 2, 1, 3, 2, 2, 2], false],
  [[2003, 3, 1, 3, 3, 3, 3], [2003, 3, 2, 3, 3, 3, 3], false],
  [[2004, 4, 1, 4, 4, 4, 4], [2004, 5, 1, 4, 4, 4, 4], false],
  [[2005, 5, 1, 5, 5, 5, 5], [2006, 5, 1, 5, 5, 5, 5], false],
  [[2006, 6, 1, 6, 6, 6, 6], [2006, 7, 1, 6, 6, 6, 6], false]
].forEach(function (test) {
  var
  ad1 = test[0],
  ...
  expect(utils.dateSameSecond(d1, d2)).to.equal(!!test[2]);
});

// TFN: dateSameMs
console.log('Testing: dateSameMs..');
[
  [[2000, 0, 1, 0, 0, 0, 0], [2000, 0, 1, 0, 0, 0, 0], true],
  [[2001, 1, 2, 1, 1, 1, 1], [2001, 1, 2, 1, 1, 1, 1], true],
  [[2002, 2, 3, 2, 2, 2, 2], [2002, 2, 3, 2, 2, 2, 2], true],
  [[2003, 3, 4, 3, 3, 3, 3], [2003, 3, 4, 3, 3, 3, 3], true],
  [[2004, 4, 5, 4, 4, 4, 4], [2004, 4, 5, 4, 4, 4, 4], true],
  [[2005, 5, 6, 5, 5, 5, 5], [2005, 5, 6, 5, 5, 5, 5], true],
  [[2006, 6, 7, 6, 6, 6, 6], [2006, 6, 7, 6, 6, 6, 6], true],

  [[2000, 0, 1, 0, 0, 0, 0], [2000, 0, 1, 0, 0, 0, 1], false],
  [[2001, 1, 1, 1, 1, 1, 1], [2001, 1, 1, 1, 1, 2, 1], false],
  [[2002, 2, 1, 2, 2, 2, 2], [2002, 2, 1, 2, 3, 2, 2], false],
  [[2003, 3, 1, 3, 3, 3, 3], [2003, 3, 1, 4, 3, 3, 3], false],
  [[2004, 4, 1, 4, 4, 4, 4], [2004, 4, 2, 4, 4, 4, 4], false],
  [[2005, 5, 1, 5, 5, 5, 5], [2005, 6, 1, 5, 5, 5, 5], false],
  [[2006, 6, 1, 6, 6, 6, 6], [2007, 6, 1, 6, 6, 6, 6], false]
].forEach(function (test) {
  ...
  expect(utils.dateSameMs(d1, d2)).to.equal(!!test[2]);
});
...
[
  [[2000, 0, 1, 0, 0, 0, 0], [2000, 0, 1, 0, 0, 0, 0], true],
  [[2000, 0, 2, 1, 1, 1, 1], [2000, 0, 2, 1, 1, 1, 1], true],
  [[2000, 0, 3, 2, 2, 2, 2], [2000, 0, 3, 2, 2, 2, 2], true],
  [[2000, 0, 4, 3, 3, 3, 3], [2000, 0, 4, 3, 3, 3, 3], true],
  [[2000, 0, 5, 4, 4, 4, 4], [2000, 0, 5, 4, 4, 4, 4], true],
  [[2000, 0, 6, 5, 5, 5, 5], [2000, 0, 6, 5, 5, 5, 5], true],
  [[2000, 1, 7, 6, 6, 6, 6], [2000, 1, 7, 6, 6, 6, 6], true],
  [[2001, 0, 8, 7, 7, 7, 7], [2001, 0, 8, 7, 7, 7, 7], true],
  [[2000, 0, 1, 0, 0, 0, 0], [2000, 0, 1, 0, 0, 0, 1], false],
  [[2000, 0, 2, 0, 0, 0, 0], [2000, 0, 2, 0, 0, 1, 0], false],
  [[2000, 0, 3, 0, 0, 0, 0], [2000, 0, 3, 0, 1, 0, 0], false],
  [[2000, 0, 4, 0, 0, 0, 0], [2000, 0, 4, 1, 0, 0, 0], false],
  [[2000, 0, 5, 0, 0, 0, 0], [2000, 0, 6, 0, 0, 0, 0], false],
  [[2000, 0, 6, 0, 0, 0, 0], [2000, 1, 6, 0, 0, 0, 0], false],
  [[2000, 0, 6, 0, 0, 0, 0], [2001, 0, 6, 0, 0, 0, 0], false]
].forEach(function (test) {
  var
  ad1 = test[0],
  ad2 = test[1],
